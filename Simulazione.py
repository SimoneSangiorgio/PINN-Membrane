...
from pathinator import model_path, csv_simulation_path, csv_real_path, csv_simulation_test_path
...
simulated_membrane = pd.read_csv(csv_simulation_test_path, names=["t", "x", "y", "z_sim"], header=None)
